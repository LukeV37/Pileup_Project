...
#define R__DICTIONARY_FILENAME v_dict
...
namespace {
  void TriggerDictionaryInitialization_v_dict_Impl() {
    static const char* headers[] = {
nullptr
    };
    static const char* includePaths[] = {
"/usr/local/rootpy27/root_install/include/",
"/home/lvaughan/Pileup/Pileup_Project/pythia/vv_example/",
nullptr
    };
    static const char* fwdDeclCode = R"DICTFWDDCLS(
#line 1 "v_dict dictionary forward declarations' payload"
...
#line 1 "v_dict dictionary payload"
...
nullptr
    ...
    if (!isInitialized) {
      TROOT::RegisterModule("v_dict",
        headers, includePaths, payloadCode, fwdDeclCode,
        TriggerDictionaryInitialization_v_dict_Impl, {}, classesHeaders, /*hasCxxModule*/false);
      isInitialized = true;
    }
  }
  static struct DictInit {
    DictInit() {
      TriggerDictionaryInitialization_v_dict_Impl();
    }
  } __TheDictionaryInitializer;
}
void TriggerDictionaryInitialization_v_dict() {
  TriggerDictionaryInitialization_v_dict_Impl();
}
